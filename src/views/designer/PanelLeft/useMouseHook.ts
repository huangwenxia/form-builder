...
import MController,{MC} from "./MController";
...
let $MController = {} as MC ;//全局
// const elementTypes: Array<string> = ["text", "image", "video", "button"]
...
const useMouseHook = (modules:Array<I.designer.FormItemType>): ReturnType => {
  $MController = MController(modules)
  return { onMousedown }
}
...
function startAdd() {
  const defaultModelData: I.designer.FormItemType | undefined = defaultData.find((a) => a.type == dragEvent.moduleType)
  if (!defaultModelData) {
