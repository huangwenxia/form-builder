        ...
        children: [
            {
                ...
                skin: {
                    containerStyle: {},
                    headerStyle: { background: "rgb(59, 103, 160)", color: "#fff", borderBottom: "5px solid #2d4e7b" }
                }
            },
            {
                name: "杜若-深",
                position: "-210px 0",
                skin: {
                    containerStyle: { backgroundColor: "#13293d" },
                    headerStyle: { background: "rgb(59, 103, 160)", color: "#fff", borderBottom: "5px solid #2d4e7b" }
                }
            },
            {
                ...
                skin: {
                    containerStyle: {},
                    headerStyle: { background: "#35a4b7", color: "#fff", borderBottom: "5px solid #247280" }
                }
            },
            {
                name: "浅葱-深",
                position: "-210px -110px",
                skin: {
            ...
            },
            {
                ...
                skin: {
                    containerStyle: {},
                    headerStyle: { background: "#68be8d", color: "#fff", borderBottom: "5px solid #388358" }
                }
            },
            {
                name: "若竹-深",
                position: "-210px -220px",
                skin: {
                    containerStyle: { backgroundColor: "#053225" },
                    headerStyle: { background: "#68be8d", color: "#fff", borderBottom: "5px solid #388358" }
                }
            },
            {
                ...
                skin: {
                    containerStyle: {},
                    headerStyle: { background: "#ec6800", color: "#fff", borderBottom: "5px solid #b95300" }
                }
            },
            {
                name: "黄赤-深",
                position: "-210px -330px",
                skin: {
                    containerStyle: { backgroundColor: "#813405" },
                    headerStyle: { background: "#ec6800", color: "#fff", borderBottom: "5px solid #b95300" }
                }
            },
            {
                ...
                skin: {
                    containerStyle: {},
                    headerStyle: { background: "#9d2933", color: "#fff", borderBottom: "5px solid #671b20" }
                }
            },
            {
                name: "胭脂-深",
                position: "-210px -440px",
                skin: {
                    containerStyle: { backgroundColor: "#bd4a4e" },
                    headerStyle: { background: "#9d2933", color: "#fff", borderBottom: "5px solid #671b20" }
                }
            },
            {
                ...
                skin: {
                    containerStyle: {},
                    headerStyle: { background: "#393e46", color: "#fff", borderBottom: "5px solid #000000" }
                }
            },
            {
                name: "蓝墨茶-深",
                position: "-210px -550px",
                skin: {
                    containerStyle: { backgroundColor: "#090909" },
                    headerStyle: { background: "#393e46", color: "#fff", borderBottom: "5px solid #000000" }
                }
            }
        ]
